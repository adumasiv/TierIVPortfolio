  ...
  return (
    <div>
      ...
      <section id="projects" className="py-20 md:py-32">
        ...
        <div className="flex md:grid md:grid-cols-2 gap-4 md:gap-10 mt-6 md:mt-12 overflow-x-auto md:overflow-visible pb-4 snap-x snap-mandatory px-5 md:px-8 max-w-none">
          {projects.map((p) => (
            <FadeIn key={p.id}>
              <div
                onClick={() => window.open(p.github, "_blank")}
                className="group relative cursor-pointer min-w-[90vw] sm:min-w-[70vw] md:min-w-0 snap-start border border-gray-800 rounded-xl overflow-hidden bg-white/5 backdrop-blur transition-all duration-300 hover:border-primary hover:shadow-[0_0_30px_rgba(99,102,241,0.4)] hover:-translate-y-1"
              >
                {/* IMAGE */}
